 ...
 * @subpackage Example
 * @version    2.6.1 for plugin Woo Mail Reminder
...
add_action( 'tgmpa_register', 'woomr_register_required_plugins' );
...
function woomr_register_required_plugins() {
	...
	$config = array(
		...
		'strings'      => array(
			...
			/* translators: 1: plugin name. * /
			'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', 'woo-mail-reminder' ),
			/* translators: 1: dashboard link. * /
			'complete'                        => __( 'All plugins installed and activated successfully. %1$s', 'woo-mail-reminder' ),
